shinyUI(navbarPage(
    ...
    tabPanel(title = "About Page",
             ...
             h2("Chundy wtf is this"),
             p("This is my janky Shiny app that randomly generates certain Sims traits based on certain probabilities written into the code. Peep the tabs for more info. They're not very well designed but they're functional. I only have novice Shiny experience. This is at least an upgrade from the last time I did the 100 babby challenge when I used even jankier Excel code. I'll put the code up on GitHub so someone can tell me how to do it better. Thanks and happy using if you'd like to test it out lol.
               ")),
    ...
    tabPanel(title="Relationships and Children", sidebarLayout(
        sidebarPanel2(
            ...
            actionButton("do2", "Sexuality"),
            actionButton("do3", "Press if LGBTQ"),
            actionButton("do4", "Relationships?"),
            actionButton("do5", "Press for Kids if No Relationships"),
            actionButton("do6", "Press if Bi or Any Gender"),
            actionButton("do7", "Marry Partner(s)?"),
            actionButton("do8", "Press if 2 Partners"),
            actionButton("do9", "Kids per Partner if Relationships"),
    ...
    tabPanel(title="Birth/Adoption", sidebarLayout(
        sidebarPanel2(
            ...
            actionButton("do11", "Kid 1"),
            actionButton("do12", "Kid 2"),
            actionButton("do13", "Kid 3"),
            actionButton("do14", "Kid 4"),
